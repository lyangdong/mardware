        ...
        <div class="phone-validate">
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="phone-ruleForm" >
            <el-form-item prop="email">
              <el-input v-model="ruleForm.email" placeholder="请输入您的邮箱账号"></el-input>
            </el-form-item>
            <el-form-item>
  ...
  export default {
    ...
    methods: {
      submitFormCode() {
        ...
        getForgetCode(this.ruleForm.email)
          .then(res=>{
            if(res.data.code == 0){
              this.$message({
                type : 'success',
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$router.push({
              name: 'forget-reset',
              params: {accountNo: this.ruleForm.email, code: this.ruleForm.code ,type:'email'}
            });
          } else {
